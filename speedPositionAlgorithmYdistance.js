...
board.on("ready", function() {
  ...
  controllerLM.on('frame',function (frame){
    ...
    if (frame.hands.length > 0) {
          ...
          /*************  calculate the distance between the middle and thumb finger *****************/
          ...
          if (handvelocity1 > 50 && handvelocity1 < 1000 && rate1_3 > 0.5) {
              ...
              if (count==5){
                  ...
                  stepperX.rpm(100).ccw().step(Math.round(Math.abs(totalErrPositionX)), function() {
              ...
              if (count2==5){
                  ...
                  totalErrPositionX = factor*totalErrPositionX;
                  //console.log('loop test1');
                  stepperX.rpm(100).cw().step(Math.round(Math.abs(totalErrPositionX)), function() {
          ...
          if (handvelocity3 > 50 && handvelocity3 < 1000 && rate3_1 > 0.5) {
            ...
            if (countZ==5){
                ...
                //console.log('loop test1');
                stepperZ.rpm(100).cw().step(Math.round(Math.abs(totalErrPositionZ)), function() {
              ...
              if (countZ2==5){ 
                  ...
                  totalErrPositionZ = factor*totalErrPositionZ;
                  //console.log('loop test1');
                  stepperZ.rpm(100).ccw().step(Math.round(Math.abs(totalErrPositionZ)), function() {
          ...
          stepperX.rpm(0);
          stepperZ.rpm(0);
          servoPen.to(45); // pen keep down when starting drawing
          }
